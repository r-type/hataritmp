...
static SGOBJ monitordlg[] =
{
	...
	{ SGBUTTON,   SG_EXIT, 0,  6,12, 1,1, "\x04", SG_SHORTCUT_LEFT },
	{ SGTEXT,     0, 0,  8,12, 4,1, sVdiWidth },
	{ SGBUTTON,   SG_EXIT, 0, 13,12, 1,1, "\x03", SG_SHORTCUT_RIGHT },
	{ SGTEXT,     0, 0,  4,13, 1,1, "x" },
	{ SGBUTTON,   SG_EXIT, 0,  6,13, 1,1, "\x04", SG_SHORTCUT_UP },
	{ SGTEXT,     0, 0,  8,13, 4,1, sVdiHeight },
	{ SGBUTTON,   SG_EXIT, 0, 13,13, 1,1, "\x03", SG_SHORTCUT_DOWN },
	...
	{ SGBUTTON, SG_EXIT, 0, 7,16, 20,1, "Back to main menu" },
...
static SGOBJ windowdlg[] =
{
	...
	{ SGBUTTON,   SG_EXIT, 0, 35,8,  1,1, "\x04", SG_SHORTCUT_LEFT },
	{ SGTEXT,     0, 0, 37,8,  4,1, sMaxWidth },
	{ SGBUTTON,   SG_EXIT, 0, 43,8,  1,1, "\x03", SG_SHORTCUT_RIGHT },
	{ SGTEXT,     0, 0, 33,9,  1,1, "x" },
	{ SGBUTTON,   SG_EXIT, 0, 35,9,  1,1, "\x04", SG_SHORTCUT_UP },
	{ SGTEXT,     0, 0, 37,9,  4,1, sMaxHeight },
	{ SGBUTTON,   SG_EXIT, 0, 43,9,  1,1, "\x03", SG_SHORTCUT_DOWN },

	{ SGBOX,      0, 0,  1,12, 50,5, NULL },
	{ SGTEXT,     0, 0,  7,13, 16,1, "Screen capture" },
	{ SGCHECKBOX, 0, 0,  8,15, 16,1, "_Crop statusbar" },
	{ SGBUTTON,   SG_EXIT, 0, 29,13, 14,1, " _Screenshot " },
	{ SGBUTTON,   SG_EXIT, 0, 29,15, 14,1, NULL },      /* Record text set later */
	...
	{ SGBUTTON, SG_EXIT, 0, 17,23, 20,1, "Back to main menu" },
#else
	{ SGBUTTON, SG_EXIT, 0, 17,18, 20,1, "Back to main menu" },
#endif
	{ SGSTOP, 0, 0, 0,0, 0,0, NULL }
};
