...
static SGOBJ haltdlg[] = {
	...
	{ SGBUTTON, SG_EXIT, 0,  6,3, 12,1, "_Warm reset" },
	{ SGBUTTON, SG_EXIT,          0,  6,5, 12,1, "_Cold reset" },
	{ SGBUTTON, SG_EXIT,          0, 28,3, 18,1, "Console _debugger" },
	{ SGBUTTON, SG_EXIT,  0, 28,5, 18,1, "_Quit Hatari" },
