...
static SGOBJ floppydlg[] =
{
	...
	{ SGBUTTON, SG_EXIT, 0, 22,18, 20,1, "Back to main menu" },
...
static SGOBJ alertdlg[] =
{
	...
	{ SGBUTTON, SG_EXIT/*0*/, 0,  3,4, 10,1, "Drive _A:" },
	{ SGBUTTON, SG_EXIT/*0*/, 0, 15,4, 10,1, "Drive _B:" },
	{ SGBUTTON, SG_EXIT, 0, 27,4, 10,1, "_Cancel" },
	{ SGSTOP, 0, 0, 0,0, 0,0, NULL }
};
