...
static SGOBJ maindlg[] =
{
	...
	{ SGBUTTON, SG_EXIT, 0,  2, 4, 13,1, "S_ystem" },
	{ SGBUTTON, SG_EXIT, 0,  2, 6, 13,1, "CP_U" },
	{ SGBUTTON, SG_EXIT, 0,  2, 8, 13,1, "_ROM" },
	{ SGBUTTON, SG_EXIT, 0,  2,10, 13,1, "_Memory" },
	{ SGBUTTON, SG_EXIT, 0, 17, 4, 16,1, "_Floppy disks" },
	{ SGBUTTON, SG_EXIT, 0, 17, 6, 16,1, "Hard _disks" },
	{ SGBUTTON, SG_EXIT, 0, 17, 8, 16,1, "_Atari screen" },
	{ SGBUTTON, SG_EXIT, 0, 17,10, 16,1, "_Hatari screen" },
	{ SGBUTTON, SG_EXIT/*0*/, 0, 35, 4, 13,1, "_Joysticks" },
	{ SGBUTTON, SG_EXIT/*0*/, 0, 35, 6, 13,1, "_Keyboard" },
	{ SGBUTTON, SG_EXIT/*0*/, 0, 35, 8, 13,1, "D_evices" },
	{ SGBUTTON, SG_EXIT/*0*/, 0, 35,10, 13,1, "S_ound" },
	{ SGBUTTON, SG_EXIT/*0*/, 0,  2,13, 13,1, "A_bout" },
	{ SGBUTTON, SG_EXIT/*0*/, 0, 17,13, 16,1, "_Load config" },
	{ SGBUTTON, SG_EXIT/*0*/, 0, 35,13, 13,1, "_Save config" },
	{ SGRADIOBUT, 0, 0, 3,15, 10,1, "_No Reset" },
	{ SGRADIOBUT, 0, 0, 3,17, 15,1, "Reset ma_chine" },
	{ SGBUTTON, SG_EXIT, 0, 21,15, 8,3, "OK" },
	{ SGBUTTON, SG_EXIT, 0, 36,15, 10,1, "_Quit" },
	{ SGBUTTON, SG_EXIT, 0, 36,17, 10,1, "Cancel" },
