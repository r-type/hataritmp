...
static SGOBJ romdlg[] =
{
	...
	{ SGBUTTON, SG_EXIT, 0, 42,5, 8,1, "_Browse" },
	...
	{ SGBUTTON, SG_EXIT, 0, 32,13, 8,1, "_Eject" },
	{ SGBUTTON, SG_EXIT, 0, 42,13, 8,1, "B_rowse" },
	...
	{ SGBUTTON, SG_EXIT, 0, 16,22, 20,1, "Back to main menu" },
