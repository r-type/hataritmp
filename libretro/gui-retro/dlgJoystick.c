...
static SGOBJ joydlg[] =
{
	...
	{ SGBUTTON, SG_EXIT, 0,  1,3, 3,1, "\x04", SG_SHORTCUT_LEFT },
	{ SGBUTTON, SG_EXIT, 0, 28,3, 3,1, "\x03", SG_SHORTCUT_RIGHT },

	{ SGBOX, 0, 0, 1,4, 30,11, NULL },
	{ SGBUTTON,   SG_EXIT, 0, 19,7, 11,1, "D_efine keys" },
	...
	{ SGBUTTON, SG_EXIT, 0,  4,11, 1,1, "\x04", SG_SHORTCUT_UP },
	{ SGBUTTON, SG_EXIT, 0, 27,11, 1,1, "\x03", SG_SHORTCUT_DOWN },

	{ SGCHECKBOX, 0, 0, 2,13, 17,1, "Enable _autofire" },

	{ SGBUTTON, SG_EXIT, 0, 6,16, 20,1, "Back to main menu" },
